 ...
 * same as that described in {@link SampleKinesisProducer}
 * 
 * <p>
...
public class MetricsAwareSampleProducer {
    private static final Logger log = LoggerFactory.getLogger(SampleKinesisProducer.class);
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        KinesisProducerConfiguration config = new KinesisProducerConfiguration()
                ...
                .setRegion(SampleKinesisProducer.REGION);
        ...
        while (true) {
            ...
            if (sequenceNumber.get() < totalRecordsToPut) {
                if (kinesisProducer.getOutstandingRecordsCount() < outstandingLimit) {
                    ...
                    ListenableFuture<UserRecordResult> f = kinesisProducer.addUserRecord(SampleKinesisProducer.STREAM_NAME,
                            timetstamp, data);
